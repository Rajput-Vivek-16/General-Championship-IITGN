...
const BasketballStandings = () => {
  const columns = ["Batch", "Played", "Wins", "Draws", "Losses", "Points"];

  // Men's Pool A
  const menPoolATeams = [
    { batch: "B.Tech'21", played: 0, wins: 0, draws: 0, losses: 0 },
    { batch: "B.Tech'22", played: 0, wins: 0, draws: 0, losses: 0 },
    { batch: "B.Tech'23", played: 0, wins: 0, draws: 0, losses: 0 },
    { batch: "PhD", played: 0, wins: 0, draws: 0, losses: 0 },
  ];

  // Men's Pool B
  const menPoolBTeams = [
    { batch: "B.Tech'24", played: 0, wins: 0, draws: 0, losses: 0 },
    { batch: "Master'23", played: 0, wins: 0, draws: 0, losses: 0 },
    { batch: "Master'24", played: 0, wins: 0, draws: 0, losses: 0 },
  ];
